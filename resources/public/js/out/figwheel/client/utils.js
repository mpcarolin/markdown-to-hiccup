...
var or__30122__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37297 = {"detail":data};
return obj37297;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30110__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30110__auto__)){
var and__30110__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37304 = cljs.core._EQ_;
var expr__37305 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37304.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37305))){
return ((function (pred__37304,expr__37305){
return (function (p1__37298_SHARP_){
return console.warn(p1__37298_SHARP_);
});
;})(pred__37304,expr__37305))
} else {
if(cljs.core.truth_(pred__37304.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37305))){
return ((function (pred__37304,expr__37305){
return (function (p1__37299_SHARP_){
return console.debug(p1__37299_SHARP_);
});
;})(pred__37304,expr__37305))
} else {
if(cljs.core.truth_(pred__37304.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37305))){
return ((function (pred__37304,expr__37305){
return (function (p1__37300_SHARP_){
return console.error(p1__37300_SHARP_);
});
;})(pred__37304,expr__37305))
} else {
return ((function (pred__37304,expr__37305){
return (function (p1__37301_SHARP_){
return console.log(p1__37301_SHARP_);
});
;})(pred__37304,expr__37305))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37308){
...
var eval_fn = cljs.core.get.call(null,map__37309__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37311_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37313,(0),null);
var v = cljs.core.nth.call(null,vec__37313,(1),null);
...
if(cljs.core.truth_((function (){var and__30110__auto__ = (typeof localStorage !== 'undefined') && (typeof goog.object.get(localStorage,"getItem") !== 'undefined');
...
}catch (e37318){if((e37318 instanceof Error)){
var e = e37318;
return not_found;
} else {
throw e37318;
...
//# sourceMappingURL=utils.js.map?rel=1543501872082
