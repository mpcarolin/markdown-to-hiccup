...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__22971){
...
var state = map__22972__$1;
var code = cljs.core.get.call(null,map__22972__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__22972__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__22974 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__22975 = cljs.core.drop.call(null,(2),remaining);
buf = G__22974;
remaining = G__22975;
continue;
} else {
var G__22976 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__22977 = cljs.core.rest.call(null,remaining);
buf = G__22976;
remaining = G__22977;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__22978){
...
var state = map__22979__$1;
var buf = cljs.core.get.call(null,map__22979__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.call(null,map__22979__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.call(null,map__22979__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__22979__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.call(null,map__22979__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__22981){
var map__22982 = p__22981;
var map__22982__$1 = ((((!((map__22982 == null)))?(((((map__22982.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22982.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22982):map__22982);
var state = map__22982__$1;
var code = cljs.core.get.call(null,map__22982__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__22982__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__22985){
...
var state = map__22986__$1;
var code = cljs.core.get.call(null,map__22986__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.call(null,map__22986__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,((function (currently_frozen,map__22986,map__22986__$1,state,code,frozen_strings){
return (function (p1__22984_SHARP_){
var vec__22988 = markdown.common.freeze_string.call(null,cljs.core.subs.call(null,p1__22984_SHARP_,(1),(cljs.core.count.call(null,p1__22984_SHARP_) - (1))),cljs.core.deref.call(null,currently_frozen));
var url = cljs.core.nth.call(null,vec__22988,(0),null);
var frozen_strings__$1 = cljs.core.nth.call(null,vec__22988,(1),null);
...
});})(currently_frozen,map__22986,map__22986__$1,state,code,frozen_strings))
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__22991_SHARP_){
var encoded = (cljs.core.truth_(new cljs.core.Keyword(null,"clojurescript","clojurescript",-299769403).cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.call(null,p1__22991_SHARP_,(1),(cljs.core.count.call(null,p1__22991_SHARP_) - (1))):cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (c){
if((cljs.core.rand.call(null) > 0.5)){
return markdown.transformers._STAR_formatter_STAR_.call(null,"&#x%02x;",(c | (0)));
} else {
return c;
}
}),cljs.core.subs.call(null,p1__22991_SHARP_,(1),(cljs.core.count.call(null,p1__22991_SHARP_) - (1))))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__22992){
...
var state = map__22993__$1;
var inline_heading = cljs.core.get.call(null,map__22993__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__22995){
...
var state = map__22996__$1;
var eof = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__22996__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__22998){
var map__22999 = p__22998;
var map__22999__$1 = ((((!((map__22999 == null)))?(((((map__22999.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22999.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22999):map__22999);
var state = map__22999__$1;
var next_line = cljs.core.get.call(null,map__22999__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.call(null,map__22999__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__3911__auto__ = paragraph;
if(cljs.core.truth_(and__3911__auto__)){
return cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__23001 = next_line;
if((G__23001 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23001);
}
})()));
} else {
return and__3911__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__23002){
...
var state = map__23003__$1;
var eof = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__23003__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__23005){
...
var codeblock = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.call(null,map__23006__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
var next_line_closes_QMARK_ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__23008 = next_line;
if((G__23008 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__23008);
}
})()));
...
var vec__23009 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__23009,(0),null);
var code = cljs.core.nth.call(null,vec__23009,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__23012){
...
var state = map__23013__$1;
var eof = cljs.core.get.call(null,map__23013__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__23013__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__23013__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__23013__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__3922__auto__ = code;
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__23015){
...
var state = map__23016__$1;
var blockquote_start = cljs.core.get.call(null,map__23016__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.call(null,map__23016__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.call(null,map__23016__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.call(null,map__23016__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__23018_SHARP_),"</ol>"].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__23019){
var vec__23020 = p__23019;
var id = cljs.core.nth.call(null,vec__23020,(0),null);
var label = cljs.core.nth.call(null,vec__23020,(1),null);
...
var vec__23023 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__23023,(0),null);
var key = cljs.core.nth.call(null,vec__23023,(1),null);
var val = cljs.core.nth.call(null,vec__23023,(2),null);
var vec__23026 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__23026,(0),null);
var next_val = cljs.core.nth.call(null,vec__23026,(1),null);
...
var vec__23029 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__23029,(0),null);
var val = cljs.core.nth.call(null,vec__23029,(1),null);
...
var G__23032 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val]));
var G__23033 = cljs.core.rest.call(null,remain);
var G__23034 = key;
acc = G__23032;
remain = G__23033;
prev_key = G__23034;
