(defproject markdown-to-hiccup "0.2.1"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "markdown-to-hiccup.core/on-js-reload"
                ...
                :compiler {:main markdown-to-hiccup.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/markdown_to_hiccup.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/markdown_to_hiccup.js"
